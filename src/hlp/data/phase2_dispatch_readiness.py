...
PHASE2_DYNAMIC_WORKFLOWS = (
    ...
    "phase2-direct-selector-approved-freeze.yml",
    "phase2-post-selector-wave-launch.yml",
    ...
    "phase2-pools-fun-promotion-propose.yml",
    "phase2-pools-fun-ledger-approved.yml",
    ...
    "phase2-pools-trade-lbp-promotion-propose.yml",
    "phase2-pools-trade-lbp-ledger-approved.yml",
    "phase2-doppler-promotion-review.yml",
    "phase2-doppler-promotion-propose.yml",
    "phase2-doppler-ledger-approved.yml",
    "phase2-flap-promotion-review.yml",
    "phase2-flap-promotion-propose.yml",
    "phase2-flap-ledger-approved.yml",
    "phase2-trench-today-promotion-review.yml",
    "phase2-trench-today-promotion-propose.yml",
    "phase2-trench-today-ledger-approved.yml",
    "phase2-hoodfun-current-promotion-review.yml",
    "phase2-hoodfun-current-promotion-propose.yml",
    "phase2-hoodfun-current-ledger-approved.yml",
    "phase2-archive-fanout-launch.yml",
    "phase2-archive-fanout-completion.yml",
    "phase2-post-fanout-wave-launch.yml",
    "phase2-post-fanout-wave-completion.yml",
)
