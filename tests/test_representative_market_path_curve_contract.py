...
def test_post_eligibility_ready_replay_is_artifact_only() -> None:
    ...
    assert '"evidence_run_id": int(os.environ["GITHUB_RUN_ID"])' in workflow
    assert "name: phase1-pons-eligible-universe" in workflow
    assert "name: phase1-pons-representative-validation" in workflow
