...
The bootstrap currently contains 47 Phase 2 workflow files:

- 46 are byte-for-byte identical to the compatibility target;
...
All 47 workflow files are manual-only on this branch: `workflow_dispatch`
